  ...
  if (community) {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <Link href="/community" className="text-blue-600 hover:underline mb-4 inline-block">← Back to Community</Link>
          <h1 className="text-4xl font-bold">{community.name}</h1>
          <p className="text-gray-600 mt-2">{community.members.toLocaleString('en-US')} members</p>
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <Card className="p-8">
        ...
        <div className="flex flex-wrap gap-4 items-center text-sm text-gray-600 mb-8 border-b pb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-xs">{post.authorRole || 'Member'}</div>
            </div>
          </div>
          {post.company && <Badge variant="info">{post.company}</Badge>}
      ...
      <div className="mt-8">
        <h3 className="text-xl font-bold mb-4">Replies ({post.replies})</h3>
        {post.replies > 0 ? (
